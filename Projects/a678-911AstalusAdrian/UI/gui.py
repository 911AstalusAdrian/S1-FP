...
class GUI:
    ...
    def start(self):
        ...
        button_add_student.grid(row=0, column=0, sticky='nsew', padx=10, pady=10)
    ...
    def add_assignment_gui(self):
        ...
        deadline_year = simpledialog.askstring(title="Add Assignment", prompt="Give the Assignment Deadline year: ")
        deadline_month = simpledialog.askstring(title="Add Assignment", prompt="Give the Assignment Deadline month: ")
        deadline_day = simpledialog.askstring(title="Add Assignment", prompt="Give the Assignment Deadline day: ")
        try:
